      ...
      content = s.loggedIn ? html`
        ...
        <section class="main ${isDesktopNonMac ? 'desktop-non-mac' : ''} ${s.showMenu ? 'menu-visible-xs' : ''}" style="flex-direction: row;">
          ...
          <${Helmet} titleTemplate=${titleTemplate} defaultTitle=${defaultTitle}>
            ...
            <meta property="og:url" content=${`https://speed2earn.games${window.location.pathname.length > 1 ? window.location.pathname : ''}`} />
            <meta property="og:image" content="https://speed2earn.games/assets/img/cover.jpg" />
