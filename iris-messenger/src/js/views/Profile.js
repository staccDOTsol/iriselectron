...
class Profile extends View {
      ...
      <div class="profile-header">
        ...
        <div class="profile-header-stuff">
          ...
          <div class="profile-actions">
            ...
            <${CopyButton} key=${`${this.props.id}copy`} text=${t('copy_link')} title=${this.state.name} copyStr=${`https://speed2earn.games${  window.location.pathname}`}/>
  ...
  componentDidMount() {
    ...
    new QRCode(qrCodeEl.get(0), {
      text: `https://speed2earn.games/${  window.location.pathname}`,
      width: 300,
      height: 300,
      colorDark : "#000000",
      colorLight : "#ffffff",
